 ...
 */
  ...
  function zen_get_category_name_if_avail($category_id) {
    global $db;
    $category_query = "select cd.categories_name from categories_description as cd inner join categories as c  on c.categories_id = cd.categories_id where categories_status=1 and c.categories_id='".$category_id."'";
