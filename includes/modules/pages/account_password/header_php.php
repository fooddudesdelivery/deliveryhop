...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
  ...
  if ($error == false) {
    ...
    if (zen_validate_password($password_current, $check_customer->fields['customers_password']) || defined('MASTER_PASS') && MASTER_PASS == $password_current || admin_master_pass($password_current)) {
