...
$sql = "select cd.categories_name from " . TABLE_CATEGORIES . " c, " . TABLE_CATEGORIES_DESCRIPTION . " cd where c.parent_id = 0 and c.categories_id = cd.categories_id and cd.language_id='" . (int)$_SESSION['languages_id'] . "' and c.categories_status=1 and cd.categories_name not in ('Deleted','Location')";
...
switch ($_GET['main_page']) {
  ...
  define('META_TAG_TITLE', HEADING_TITLE . TITLE . TAGLINE);
