<?php
/**
 * featured footer - displays a random Featured Product
 *
...
$random_featured_product = $db->ExecuteRandomMulti($random_featured_products_query, 3);

if ($random_featured_product->RecordCount() > 0)  {
  $title =  BOX_HEADING_FEATURED_PRODUCTS;
  $box_id = 'featured-widget';
  require($template->get_template_dir('tpl_featured.php',DIR_WS_TEMPLATE, $current_page_base,'footer'). '/tpl_featured.php');
}
?>