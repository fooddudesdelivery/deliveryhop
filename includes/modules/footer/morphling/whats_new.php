...
$random_whats_new_sidebox_product_query .= $limit;
...
if ($random_whats_new_sidebox_product->RecordCount() > 0 ) {
  ...
  $box_id = 'latest-widget';
  require($template->get_template_dir('tpl_whats_new.php',DIR_WS_TEMPLATE, $current_page_base,'footer'). '/tpl_whats_new.php');
}
