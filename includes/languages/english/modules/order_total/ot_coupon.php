 ...
 */
  ...
  define('MODULE_ORDER_TOTAL_COUPON_TITLE', 'Discount');
  ...
  define('MODULE_ORDER_TOTAL_COUPON_REDEEM_INSTRUCTIONS', '<p>To use a coupon please enter your coupon code in the box and click update. Note: only one per order.</p>');
