<?php
  ...
  if (IS_ADMIN_FLAG === true) {
	define('MODULE_PAYMENT_BRAINTREE_TEXT_ADMIN_DESCRIPTION', '<strong>Braintree</strong>%s<br /><a href="https://www.braintreepayments.com/" target="_blank">Manage your Braintree account.</a><br />');
  }
  ...
  define('MODULE_PAYMENT_BRAINTREE_TEXT_CREDIT_CARD_CHECKNUMBER_LOCATION', '');
  ...
  define('MODULE_PAYMENT_BRAINTREE_ENTRY_REFUND_DEFAULT_MESSAGE', '');
