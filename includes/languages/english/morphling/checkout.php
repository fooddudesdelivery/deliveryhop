...
define('DRIVER_TIP', 'Driver Gratuity');
//TABLE HEADINGS
define('TABLE_HEADING_PAYMENT_METHOD', 'Billing Details');
define('TABLE_SUBHEADING_PAYMENT_METHOD', 'Payment Method');
define('TABLE_HEADING_SHIPPING_METHOD', 'Delivery Details'); 
define('TABLE_SUBHEADING_SHIPPING_METHOD', 'Delivery Method'); 
define('TABLE_HEADING_COMMENTS', 'Special Instructions'); 
define('TABLE_HEADING_SHIPPING_ADDRESS', 'Delivery Address');
define('TABLE_HEADING_SHOPPING_CART', 'Order Contents');
...
define('TABLE_HEADING_ORDER_TOTALS', 'Order Totals');
