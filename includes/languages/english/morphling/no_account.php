...
define('NAVBAR_TITLE', 'Delivery Information');

define('TABLE_HEADING_BILLING_ADDRESS', 'Billing Address');
define('TABLE_HEADING_SHIPPING_ADDRESS', 'Delivery Address');

define('HEADING_TITLE', 'Checkout - step 1 / 3');
...
define('ENTRY_COPYBILLING', 'Same Address for Billing');
