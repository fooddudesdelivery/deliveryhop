...
define('SUB_TITLE_REVIEW', 'Please tell us what you think and share your opinions with others. Be sure to focus your comments on the item.');
...
define('EMAIL_REVIEW_PENDING_SUBJECT','Item Review Pending Approval: %s');
define('EMAIL_PRODUCT_REVIEW_CONTENT_INTRO','A Item Review for %s has been submitted and requires your approval.'."\n\n");
