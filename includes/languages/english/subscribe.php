...
define('EMAIL_TEXT', 'This email has been registered for a newsletter subscription. Before you can begin receiving the newsletter, you must confirm your email address.<p />' . "\n\n" . 'If you did not subscribe, no action is needed.<p />' . "\n\n" . '');
...
//define('EMAIL_CLOSURE','Sincerely,' . "\n\n" . STORE_OWNER . "\n" . '<a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS ." </a><br />\n\n");
