...
<p class="style1">
<em><strong>
  Users of the Website Generally</strong></em></p>
<p class="style1">
...
<ul>
  <li>
   <strong> Mobile Device. </strong>If you use a mobile device to access the Website or download any of our applications, we may collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and IP address.</li>
  <li>
    
    <strong>Geo-Location Information.</strong> Unless we have received your prior consent, we do not access or track any location-based information from your mobile device at any time while downloading or using our mobile application or our services, except that it may be possible for Company to determine from an IP address the geographic location of your point of connectivity, in which case we may gather and use such general location data.</li>
  <li>
    
    <strong>Push Notifications.</strong> We send you push notifications if you choose to receive them, letting you know when someone has sent you a message or for other service-related matters. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings.</li>
  <li>
    
    <strong>Mobile Analytics.</strong> We use mobile analytics software to allow us to better understand the functionality of our mobile software on your phone. This software may record information, such as how often you use the application, the events that occur within the application, aggregated usage, performance data and where the application was downloaded from. We do not link the information we store within the analytics software to any Personally-Identifying Information you submit within the mobile application.
  </li>
</ul>
...
<p class="style1">
<em><strong>
  Website Registration</strong></em></p>
<p class="style1">
...
<p class="style1">
BY REGISTERING WITH OR USING THE WEBSITE, YOU CONSENT TO THE USE AND DISCLOSURE OF YOUR PERSONALLY-IDENTIFYING INFORMATION AS DESCRIBED IN THIS “COLLECTION, USE AND DISCLOSURE OF PERSONALLY-IDENTIFYING INFORMATION” SECTION.</p>

<p class="style1">
<em><strong>
Company Communications  </strong></em></p>
<p class="style1">
...
<p class="style1">
<em><strong>
Company Disclosures  </strong></em></p>
<p class="style1">
Company will disclose Personally-Identifying Information under the following circumstances: </p>

<ul>
  <li>
<strong>By Law or to Protect Rights.</strong> When we believe disclosure is appropriate, we may disclose Personally-Identifying Information in connection with efforts to investigate, prevent or take other action regarding illegal activity, suspected fraud or other wrongdoing; to protect and defend the rights, property or safety of Company, our users, our employees or others; to comply with applicable law or cooperate with law enforcement; to enforce our Terms of Use or other agreements or policies, in response to a subpoena or similar investigative demand, a court order or a request for cooperation from a law enforcement or other government agency; to establish or exercise our legal rights; to defend against legal claims; or as otherwise required by law. In such cases, we may raise or waive any legal objection or right available to us.   </li>
  <li>
    
<strong>Marketing Communications.</strong> Unless users opt-out from receiving Company marketing materials upon registration, Company may email users about products and services that Company believes may be of interest to them. If you wish to opt-out of receiving marketing materials from Company, you may do so by following the unsubscribe link in the email communications, by going to your account settings (if applicable) or contacting us using the contact information below.    </li>
  <li>
    
<strong>Third-Party Service Providers.</strong> We may share your Personally-Identifying Information, which may include your name and contact information (including email address) with our authorized service providers that perform certain services on our behalf. These services may include fulfilling orders, providing customer service and marketing assistance, performing business and sales analysis, supporting the Website’s functionality and supporting contests, sweepstakes, surveys and other features offered through the Website. We may also share your name, contact information and credit card information with our authorized service providers who process credit card payments. These service providers may have access to personal information needed to perform their functions but are not permitted to share or use such information for any other purpose.    </li>
  <li>
    
<strong>Business Transfers; Bankruptcy.</strong> Company reserves the right to transfer all Personally-Identifying Information in its possession to a successor organization in the event of a merger, acquisition, bankruptcy or other sale of all or a portion of Company’s assets. Other than to the extent ordered by a bankruptcy or other court, the use and disclosure of all transferred Personally-Identifying Information will be subject to this Privacy Policy, or to a new privacy policy if you are given notice of that new privacy policy and are given an opportunity to affirmatively opt-out of it. Personally-Identifying Information submitted or collected after a transfer, however, may be subject to a new privacy policy adopted by the successor organization.   </li>
</ul>


<p class="style1">
<em><strong>
Changing Personally-Identifying Information; Account Termination  </strong></em></p>
<p class="style1">
...
<h4>
COLLECTION AND USE OF INFORMATION BY THIRD PARTIES GENERALLY</h4>
<p class="style1">
...
<h4>CONTACT</h4>
<p class="style1">
If you have any questions regarding our Privacy Policy, please contact Company as set forth below. </p>
