...
if ( ($category_depth == 'items') || (zen_check_url_get_terms()) ) {
  // This section deals with item-listing page contents
  define('HEADING_TITLE', 'Available Items');
  define('TABLE_HEADING_IMAGE', 'Item Image');
  ...
  define('TEXT_NO_PRODUCTS2', 'There is no item available from this manufacturer.');
  ...
  // This section deals with the "home" page at the top level with no options/items selected
