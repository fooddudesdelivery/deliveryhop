...
define('TEXT_COUPON_HELP_MINORDER', '<p>You need to spend %s to use this coupon, on qualifying items.</p>');
...
define('TEXT_COUPON_HELP_PRODUCTS', '<p class="bold">Item Restrictions:</p>');
define('TEXT_ALLOW', 'Allow');
define('TEXT_DENY', 'Deny');

define('TEXT_NO_CAT_TOP_ONLY_DENY', '<p>This coupon has specific Item Restrictions.');
define('TEXT_NO_CAT_RESTRICTIONS', '<p>This coupon is valid for all categories.</p>');
define('TEXT_NO_PROD_RESTRICTIONS', '<p>This coupon is valid for all items.</p>');
