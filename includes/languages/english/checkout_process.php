...
define('EMAIL_THANKS_FOR_SHOPPING','Thanks for ordering with us today!');
define('EMAIL_DETAILS_FOLLOW','The following are the details of your order.');
define('EMAIL_TEXT_ORDER_NUMBER', 'Order Number:');
define('EMAIL_TEXT_INVOICE_URL', 'Detailed Receipt:');
define('EMAIL_TEXT_INVOICE_URL_CLICK', 'Click here for a Detailed Receipt');
define('EMAIL_TEXT_DATE_ORDERED', 'Date Ordered:');
define('EMAIL_TEXT_PRODUCTS', 'Items');
define('EMAIL_TEXT_SUBTOTAL', 'Subtotal:');
define('EMAIL_TEXT_TAX', 'Tax:        ');
define('EMAIL_TEXT_SHIPPING', 'Delivery: ');
define('EMAIL_TEXT_TOTAL', 'Order Total:');
