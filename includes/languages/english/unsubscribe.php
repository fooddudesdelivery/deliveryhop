...
define('UNSUBSCRIBE_TEXT_INFORMATION', '<br />We\'re sorry to hear that you wish to unsubscribe from our newsletter. If you have concerns about your privacy, please see our <a href="' . zen_href_link(FILENAME_PRIVACY,'','NONSSL') . '"><span class="pseudolink">privacy notice</span></a>.<br /><br />Subscribers to our newsletter are kept notified of new items, price reductions, and site news.<br /><br />If you still do not wish to receive our newsletter, please click the button below. ');
define('UNSUBSCRIBE_TEXT_NO_ADDRESS_GIVEN', '<br />We\'re sorry to hear that you wish to unsubscribe from our newsletter. If you have concerns about your privacy, please see our <a href="' . zen_href_link(FILENAME_PRIVACY,'','NONSSL') . '"><span class="pseudolink">privacy notice</span></a>.<br /><br />Subscribers to our newsletter are kept notified of new items, price reductions, and site news.<br /><br />If you still do not wish to receive our newsletter, please click the button below. You will be taken to your account-preferences page, where you may edit your subscriptions. You may be prompted to log in first.');
...
define('UNSUBSCRIBE_EMAIL_WELCOME', 'Newsletter unsubscription confirmation from ' . STORE_NAME . '.');
...
define('UNSUBSCRIBE_EMAIL_DISCLAIMER_NEW_CUSTOMER', '');
