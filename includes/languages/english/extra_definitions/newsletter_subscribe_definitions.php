...
define('SUBSCRIBE_DUPLICATE_CUSTOMERS_ERROR', 'There is already a customer account using that email address. To subscribe, please Login and select the My Account link at the top right.');
