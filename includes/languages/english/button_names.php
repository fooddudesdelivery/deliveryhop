 ...
 */
define('TABLE_HEADING_DATETIME','Order Times');
...
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Add Selected Items to Cart');
define('BUTTON_BACK_ALT', 'Back');
define('BUTTON_BUY_NOW_ALT', 'Buy Now');
define('BUTTON_CANCEL_ALT', 'Cancel');
define('BUTTON_CHANGE_ADDRESS_SHIP', 'Change Shipping Address');
define('BUTTON_CHANGE_ADDRESS_BILL', 'Change Billing Address');
define('BUTTON_CHECKOUT_ALT', 'Checkout');
define('BUTTON_CONFIRM_SEND_ALT', 'Send Gift Certificate');
define('BUTTON_CONFIRM_ORDER_ALT', 'Place Order');
define('BUTTON_CONTINUE_ALT', 'Continue');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Continue Ordering');
...
define('BUTTON_IN_CART_ALT', 'Add to Order');
...
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Return to the Item List');
...
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Go To This Item\'s Detailed Information');
define('BUTTON_MORE_REVIEWS_ALT', 'Read More Reviews');
define('BUTTON_RESET', 'Reset Password');
