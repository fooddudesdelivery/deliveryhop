...
define('TEXT_PRODUCT_NOT_FOUND', 'Sorry, the item was not found.');
define('TEXT_CURRENT_REVIEWS', 'Current Reviews:');
define('TEXT_MORE_INFORMATION', 'For more information, please visit this item\'s <a href="%s" target="_blank">webpage</a>.');
define('TEXT_DATE_ADDED', 'This item was added to our catalog on %s.');
define('TEXT_DATE_AVAILABLE', 'This item will be in stock on %s.');
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Customers who bought this item also purchased...');
