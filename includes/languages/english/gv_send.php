...
define('HEADING_TEXT','Please enter the name, email address and amount of the ' . TEXT_GV_NAME . ' you wish to send. ');
...
define('MAIN_MESSAGE', 'You are sending a ' . TEXT_GV_NAME . ' worth %s to %s,  whose email address is %s.<br /><br />The message you are sending is:<br /><br />');
