...
define('TEXT_NO_PRODUCTS','<CENTER>OPENING SOON<br /><br /><a href="restaurantowners">If you are a restaurant and want to sign up click here for more information</a></CENTER>');
define('GIFT_CARD_SUBJECT','Gift Card Sale');
define('REWARDS_HOW_IT_WORKS','When you order food through us you build up rewards points. This is where you spend them, please login to see your balance or order gift cards');
define('GIFT_CARDS_HOW_IT_WORKS','define me');
define('LOGIN_TO_USE_POINTS','Please login to use points');
define('NOT_ENOUGH_POINTS','You do not have enough points for this');
define('NO_CARDS_WITH_CARDS','Gift cards cannt be purchased with different types of gift cards');
define('NO_CARDS_WITH_FOOD','Gift cards cannot be purchased with food');
define('GIFT_CARD_PARENT_ID',11678);
define('REWARDS_PARENT_ID',11677);
define('RETURN_TO_RESTAURANT','Menu');
define('DEPLOY_ADDRESS','Enter Address');
define('DEPLOY_TIMECODE','Select Time');
define('ONLY_ONE_RESTAURANT','Ordering from only one restaurant allowed');
define('RESTAURANT_TO_ADDRESS_UNAVAIL',"This restaurant isn't available for your address");
define('PRIMARY_PHONE_ORDER_EMAIL',"guest@staging.fooddudesdelivery.com");
define('EMAIL_TEXT_DATE_DELIVER',"Delivery Date:");
define('ASAP_FRONT_PAD',3600);
define('TEXT_ORIGIN_LOGIN', 'If you have an account with us, you may login at the <a href="%s"><em>Login Page</em></a>.');
// zm edit
if ($_SESSION['customer_id']) { 

define('TEXT_REWARD_SIDEBOX', '

Food Dudes Rewards earns you points with every online order.
<br /><br />
Rewards are easy to earn and redeem. Earn 1 point for every dollar spent
(excluding tax, delivery fee, and gratuity). Reward points can be redeemed
online for gift cards and more!
<br /><br />
...
<br /><br />
<div class="style2" >
<a href="index.php?main_page=account" style="color:#ef6f00">Login</a> to check your current rewards balance.
</div>

');

}
define('PAYPAL_LOGIN','Have a PayPal account?');
...
// Define the name of your Gift Certificate as Gift Voucher, Gift Certificate, Zen Cart Dollars, etc. here for use through out the shop
  ...
  define('TEXT_GV_NAMES','Gift Certificate');
...
// reviews box text in sideboxes/reviews.php
  ...
  define('BOX_REVIEWS_WRITE_REVIEW', 'Write a review on this item.');
  define('BOX_REVIEWS_NO_REVIEWS', 'There are currently no item reviews.');
  define('BOX_REVIEWS_TEXT_OF_5_STARS', '%s of 5 Stars!');

// shopping_cart box text in sideboxes/shopping_cart.php
  define('BOX_HEADING_SHOPPING_CART', 'My Order');
  define('BOX_SHOPPING_CART_EMPTY', 'Your order is empty.');
...
// manufacturer box text
  ...
  define('BOX_MANUFACTURER_INFO_OTHER_PRODUCTS', 'Other items');
...
// information box text in sideboxes/information.php
  ...
  define('BOX_INFORMATION_UNSUBSCRIBE', 'Unsubscribe');
...
// javascript messages
  ...
  define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Please enter a valid email address.');
  define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Looks like you have an account with us, please use a different email for guest checkout');
  ...
  define('ENTRY_NEWSLETTER', 'Subscribe to our email and text promotions.');
  ...
  define('TEXT_SORT_PRODUCTS', 'Sort items ');
  ...
  define('TEXT_NO_REVIEWS', 'There are currently no item reviews.');

  define('TEXT_NO_NEW_PRODUCTS', 'More new items will be added soon. Please check back later.');
  ...
  define('WARNING_DOWNLOAD_DIRECTORY_NON_EXISTENT', 'Warning: The downloadable items directory does not exist: ' . DIR_FS_DOWNLOAD . '. Downloadable items will not work until this directory is valid.');
  ...
  define('TEXT_BALANCE_IS', TEXT_GV_NAME . ' Balance: ');
...
// payment method is GV/Discount
  ...
  define('REDEEMED_RESTRICTIONS', ' [Item-Category restrictions apply]');
  define('TEXT_ERROR', 'An error has occurred');
  define('TEXT_INVALID_COUPON_PRODUCT', 'This coupon code is not valid for any item currently in your order.');
  define('TEXT_VALID_COUPON', 'Coupon code has been applied');
...
// cart contents
  define('PRODUCTS_ORDER_QTY_TEXT_IN_CART','Quantity: ');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', 'Successfully added Item to the order ...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', 'Successfully added selected Item(s) to the order ...');
...
// product_listing
  ...
  define('PRODUCTS_QUANTITY_IN_CART_LISTING','In order:');
  ...
  define('ERROR_MAXIMUM_QTY','The quantity added to your order has been adjusted because of a restriction on maximum you are allowed. See this item:<br />');
  define('ERROR_CORRECTIONS_HEADING','Please correct the following: <br />');
  define('ERROR_QUANTITY_ADJUSTED', 'The quantity added to your order has been adjusted. The item you wanted is not available in fractional quantities. The quantity of item:<br />');
...
// shopping cart errors
  ...
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART','<br />We are sorry but this item has been removed from our inventory at this time.<br />This item has been removed from your order.');
  define('ERROR_PRODUCT_ATTRIBUTES','<br />The item: ');
  define('ERROR_PRODUCT_STATUS_SHOPPING_CART_ATTRIBUTES','<br />We are sorry but selected options have changed for this item and have been removed from our inventory at this time.<br />This item has been removed from your order.');
  ...
  define('WARNING_SHOPPING_CART_COMBINED', 'NOTICE: For your convenience, your current order has been combined with your order from your last visit. Please review your order before checking out.');
...
// Shipping Estimator
  ...
  define('EMPTY_CART_TEXT_NO_QUOTE', 'Whoops! Your session has expired ... Please update your order for Shipping Quote ...');
  define('CART_SHIPPING_QUOTE_CRITERIA', 'Shipping quotes are based on the address information you selected:');

// multiple item add to cart
...
// table headings for cart display and upcoming items  define('TABLE_HEADING_QUANTITY', 'Qty.');
...
// create account - login shared
  ...
  define('ERROR_TEXT_COUNTRY_DISABLED_PLEASE_CHANGE', 'Sorry, there was an error with your state selection.  Please try again.');
