...
//				new google.maps.LatLng(42.892063648004395, -98.28369179687502),
//   				new google.maps.LatLng(47.53203774904758, -89.49462929687502));		 
//  		 		var searchBox_a = new google.maps.places.SearchBox(input_a,{bounds:defaultBounds});
//
//  		 google.maps.event.addListener(searchBox_a, 'places_changed', function() {
//			 console.log(searchBox_a);
//    		 var places = searchBox_a.getPlaces();
//			 console.log(places);
...
//		cache: false,
//		url: "zm_ajax.php",
//		data: {zm_session_add_delivery_time:date},
//		dataType: 'json',
//		async:true,
//		error: function(){
...
//				add_message_to_stack("Sorry "+data['closed_city']+" is currently closed, please try again later.");
//				return
//			}else{
