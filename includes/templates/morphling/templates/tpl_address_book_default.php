...
<h1 id="addressBookDefaultHeading" class="page-default-heading hiddenField"><?php echo HEADING_TITLE; ?></h1>
 
<?php if ($messageStack->size('addressbook') > 0) echo $messageStack->output('addressbook'); ?> 
      
<p id="addressBookDefaultPrimary" class="important"><?php echo PRIMARY_ADDRESS_TITLE; ?></p>
...
<div class="text-danger"><?php echo sprintf(TEXT_MAXIMUM_ENTRIES, MAX_ADDRESS_BOOK_ENTRIES); ?></div>
<br class="clearBoth" />
<?php
/**
...
?>
   <div class="buttonRow pull-left"><?php echo '<a href="' . zen_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL') . '" class="pt-button">' . BUTTON_ADD_ADDRESS_ALT . '</a>'; ?></div>
<?php
  }
?>
