...
if(empty($_SERVER['HTTPS'])){
	//zen_redirect(zen_href_link('login_as_customer', '', 'SSL'));
}
...
//$url = "https://staging.fooddudesdelivery.com/index.php?main_page=login&action=process";
$url = _SITE_FRONT_URL."/index.php?main_page=login&action=process";
?>
