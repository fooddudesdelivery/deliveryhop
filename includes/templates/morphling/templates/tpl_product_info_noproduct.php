...
<p id="productInfoNoProductMainContent" class="content"><?php echo TEXT_PRODUCT_NOT_FOUND; ?></p>

<div class="buttonRow"><a href="<?php echo zen_back_link(true); ?>" class="pt-button"><?php echo BUTTON_CONTINUE_ALT; ?></a></div>
