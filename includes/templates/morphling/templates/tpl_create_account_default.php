...
<h1 id="createAcctDefaultHeading" class="page-default-heading"><?php echo HEADING_TITLE; ?></h1>
...
<br>
<div class="buttonRow pull-right"><input type="submit" value="<?php echo BUTTON_SUBMIT_ALT; ?>" class="pt-button"></div>
</form>
</div>