    ...
    <div class="fec-col-left">
        <fieldset class="fec-fieldset">
                  ...
                  <?php if (enable_shippingAddressCheckbox()) { ?>
                    ...
                    ?>
                                ...
                                <div class="fec-field">
                                    ...
                                    <?php
									$states = zen_prepare_country_zones_pull_down(223);
									//foreach($states as $key=>$val){
									//	if(!in_array($val['text'],array('Illinois','Minnesota','South Dakota','North Dakota','Iowa','Wisconsin','Colorado'))){
									//		unset($states[$key]);
									//	}
									//}
									//$states = array_values($states);
                                    echo zen_draw_pull_down_menu('zone_id_shipping',$states , 34, 'id="stateZoneShipping"');
                                    ?>
                                </div>
                                    <?php     
                                        }
            ...
            <div class="fec-cl-right">
                ...
                <!-- //for future releases -->
                <?php if(enable_shippingAddressCheckbox()) { ?>
                   <fieldset class="fec-billing-address collapse" id="no-acct-billing">
                ...
                <fieldset id="contactDetails" class="fec-login-details">
                    ...
                    <div class="fec-field">
						...
						if($_SESSION['fooddudestaging_login']==1){
							$_SESSION['email_address']=PRIMARY_PHONE_ORDER_EMAIL;
							$disabled=' readonly="true" ';
						}
						
						?>
                        <?php echo zen_draw_input_field('email_address', $_SESSION['email_address'], 'size=33'  . ' id="email-address" '.$disabled.'') . (zen_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '': ''); ?>
                  ...
                  <?php if (!isset($_GET['type']) || $_GET['type'] != 'free_virtual') { ?>
                      ...
                      ?>
                          <div class="fec-field">
                              <label class="inputLabel" for="telephone"><?php echo ENTRY_TELEPHONE_NUMBER; ?> <span class="alert"><?php echo ENTRY_TELEPHONE_NUMBER_TEXT; ?></span></label>
                              <?php echo zen_draw_input_field('telephone', $_SESSION['telephone'], 'size=33'  . ' id="telephone"') . (zen_not_null(ENTRY_TELEPHONE_NUMBER_TEXT) ? '': ''); ?>
                          </div> <!-- end/telephone -->
                      <?php } ?>
                  ...
                  ?>
                                  <?php echo  '<br />' ?>
                      <div class="fec-box-check-radio <?php echo isset($_SESSION['fooddudestaging_login']) ? ' hiddenField ' : '' ?>" >
