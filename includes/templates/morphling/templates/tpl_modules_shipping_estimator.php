...
<?php echo zen_js_zone_list('SelectedCountry', 'theForm', 'zone_id'); ?>
  ...
  jQuery('form[name="estimator"]').submit(function(ev){
    ev.preventDefault();
    ...
    jQuery.ajax({
      ...
      success: function(data){
        jQuery.magnificPopup.open({
          items: {
            src: '<?php echo zen_href_link(FILENAME_POPUP_SHIPPING_ESTIMATOR); ?>'
          },
          type: 'ajax'
...
?>
<div class="buttonRow pull-right"><input type="submit" value="<?php echo BUTTON_UPDATE_ALT; ?>" class="pt-button"></div>
<div class="clearfix"></div>
<?php
      }
    }
