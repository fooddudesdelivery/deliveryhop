...
?>
<br class="clearBoth" />
<div class="buttonRow back"><?php echo '<a href="' . zen_href_link(FILENAME_ADVANCED_SEARCH, zen_get_all_get_params(array('sort', 'page', 'x', 'y')), 'NONSSL', true, false) . '" class="pt-button">' . BUTTON_BACK_ALT . '</a>'; ?></div>
