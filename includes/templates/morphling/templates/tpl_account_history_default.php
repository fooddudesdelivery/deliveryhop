...
<h1 id="accountHistoryDefaultHeading" class="page-default-heading"><?php echo HEADING_TITLE; ?></h1>
...
<br class="clearBoth" />
    <div class="content"><b>Restaurant: </b><?php echo $history['categories_name'] ?></div>
    <div class="content"><?php echo '<strong>' . TEXT_ORDER_DATE . '</strong> ' . zen_date_long($history['date_purchased']) /*. '<br /><strong>' . $history['order_type'] . '</strong> ' . zen_output_string_protected($history['order_name']); ?></div>
    ...
    <div class="content pull-right"><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT_HISTORY_INFO, (isset($_GET['page']) ? 'page=' . $_GET['page'] . '&' : '') . 'order_id=' . $history['orders_id'], 'SSL') . '" class="pt-button pt-button-vs">' . BUTTON_VIEW_SMALL_ALT . '</a>'; ?></div>
<br class="clearBoth" />
</fieldset>
<?php
    }
...
?>
<div class="buttonRow pull-right"><?php echo '<a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '" class="pt-button">' . BUTTON_BACK_ALT . '</a>'; ?></div>
