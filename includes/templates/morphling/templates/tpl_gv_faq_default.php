...
<p id="gvFaqDefaultContent" class="content"><?php echo SUB_HEADING_TEXT; ?></p>
...
<div class="form-group">
	...
	<?php echo zen_draw_input_field('gv_no', $_GET['gv_no'], 'size="24" id="lookup-gv-redeem"');?>
	<div class="buttonRow pull-right"><input type="submit" value="<?php echo BUTTON_REDEEM_ALT; ?>" class="pt-button"></div>
</div>
</fieldset>
