...
if(isset($_GET['term']) && !empty($_GET['term'])){
	...
	/*$qry .= " CONCAT (pd.products_name, ' ($', FORMAT(p.products_price, 2), ')', ' [', products_model, ']', ' - ID# ', p.products_id) as label, ";
	$qry .= " CONCAT (pd.products_name, ' ($', FORMAT(p.products_price, 2), ')', ' [', products_model, ']', ' - ID# ', p.products_id) as value, ";*/
