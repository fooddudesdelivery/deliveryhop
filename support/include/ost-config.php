...
define('SECRET_SALT','a15ff84271c3c5e0ece7849905e96edd');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','dcarlson@deliverhop.app');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','192.168.1.11');
define('DBNAME','deliverhop_ostic67');
define('DBUSER','deliverhop_ostic67');
define('DBPASS','.2(3EP6X5S');

# Table prefix
define('TABLE_PREFIX','ostv8_');
