...
require('order_online/class/gincredit.php');
...
if(isset($_GET['wokorder'])){
	...
	orderGenerateGinger($_GET);	
	}
	//print_r($var);
	//die;
	
	//$finish=true;
	//header('Location: https://staging.fooddudesdelivery.com/gingerootz.php?complete=1&id='.$_SESSION['new_id']);
    header('Location: '._SITE_FRONT_URL.'/gingerootz.php?complete=1&id='.$_SESSION['new_id']);
...
$(document).ready(function(e) {
	...
	$(document).on('keyup','#Subtotal',function(){
		$('#Tax').val((this.value*.05).toFixed(2));
...
<input type="hidden" name="action" value="add">
    <div class="form-group" >
        <label for="Number">GingeRootz Order Number</label>
    ...
    <div class="form-group">
        ...
        <input readonly name="delivery" type="text" class="form-control kill am check" id="Delivery" value="4.99">
    </div>
