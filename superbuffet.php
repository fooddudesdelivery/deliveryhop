...
if(isset($_GET['wokorder'])){
	...
	//$finish=true;
    //header('Location: https://staging.fooddudesdelivery.com/superbuffet.php?complete=1');
	header('Location: '._SITE_FRONT_URL.'/superbuffet.php?complete=1');
	die;
}
...
$(document).ready(function(e) {
	...
	//	$('#Tax').val((this.value*.07).toFixed(2));
