	...
	render: function render() {
		...
		if (this.props.orders.length) {
			orderNodes = this.props.orders.map(function (order, index) {
				return React.createElement(Order, { timeframe: this.props.timeframe, extras: order.extras, orders_info: order.orders_info, products: order.products, key: index, setOrdersId: this.props.setOrdersId });
			}.bind(this));
		}
		return React.createElement(
			'div',
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'col-xs-12 btn btn-default', ref: 'refr' },
						'Place Another'
					)
				),
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'button',
							{ type: 'button', id: 'main_submit', onClick: this.placeCashOrder, className: 'col-xs-12  btn btn-default subbtn' },
							'Place Order'
						)
					),
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'button',
								{ type: 'button', onClick: this.placeCreditOrder, className: 'col-xs-12 btn btn-default subbtn' },
								'Place Order'
							),
